  ...
  <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          {{ Form::select('course_id',$course, null, ['class'  => 'form-control','id' => 'courseId','placeholder' => 'Seleccione','required']) }}
        </div>
        <div class="col-md-6">
          {{ Form::label('Elija Un Servicio  ofertado por esta Asignatura')}}
          {{ Form::select('service_type_id',$serviceType, null, ['class'  => 'form-control', 'id' => 'serviceTypeId','placeholder' => 'Seleccione','required']) }}
        </div>
